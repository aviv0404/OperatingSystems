...
void analyzeLine(char* line, char*** historyList) {
    ...
    if (toSaveInHistory[0] == '!'){
        //execute history command
        //get index
        char historyIndexString[MAX_LINE_LENGTH + 1];
        strcpy(historyIndexString, toSaveInHistory);
        // get first word of toSaveInHistory, remove '!' and convert the rest of the string to int
